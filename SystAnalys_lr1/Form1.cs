...
namespace SystAnalys_lr1
{
    public partial class Form1 : Form
    {
        ...
        private void BtRandom_Click(object sender, EventArgs e)
        {
            ...
            count = rnd.Random(count,ref flag);*/
            ...
            if (!flag)
            {
                ...
                listBoxMatrix.Items.AddRange(File.ReadAllLines("Res/" + count1 + ".txt"));
                flag = true;
                Thread.Sleep(700);
                sheet.Load("Res/" + count1 + ".bmp");
            ...
            if (sheet.Image != null)
            {
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    foreach (string str in listBoxMatrix.Items)
                        textBox.Text += str + System.Environment.NewLine;
